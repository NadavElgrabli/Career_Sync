...
class JobisjobSpider(scrapy.Spider):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.max_job_search = 4
        self.jobs_scraped = 0
        self.kwargs = kwargs

    def start_requests(self):
        url = (f'https://www.jobisjob.com/m/search?whatInSearchBox={self.job}'
               f'&whereInSearchBox={self.location}&directUserSearch=true&page=1&order=')
